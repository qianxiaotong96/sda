...
int main(int argc, char ** argv){
  int i;
  // tas binaire
  tas_binaire_t * a = tas_binaire_create();
  ...
  for(i = 0; i < 1000000 ; i++){
    ...
    analyzer_append(copy_analysis, (memory_allocation)? tas_binaire_size(a):1 );
